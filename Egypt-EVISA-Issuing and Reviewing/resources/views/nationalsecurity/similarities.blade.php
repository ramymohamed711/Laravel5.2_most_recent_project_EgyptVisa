        ...
        <div class="panel-body" >
          ...
          <div id="application">
            ...
            <div class="col-md-12 col-md-offset-1">
             ...
             <a href="#" onclick="sec_off_approval('{{$application->application_no}}')" class="btn 
               btn-primary btn-md col-md-2 col-md-offset-2"> <i class="glyphicon glyphicon-ok"></i> <b>تصريح دخول</b> 
             </a>    

             <a href="#" onclick="sec_off_rejection('{{$application->application_no}}')" class="btn btn-primary btn-md col-md-2 col-md-offset-2 "> <i class="glyphicon glyphicon-remove"></i> <b>عدم تصريح الدخول</b>
             </a> 
