                ...
                <div class="panel-body">
                    ...
                    <div id="application">
                        ...
                        <tbody>
                            ...
                            <td><a  onclick="sec_get_similarties('{{$application->application_no}}')" href="#"><i class="glyphicon glyphicon-user"> </i></a> </td>
                            <td ><a href='#' onclick="sec_off_printapplication('{{base64_encode(urlencode($application->application_no))}}')"><i class="glyphicon glyphicon-print"></i></a></td>
                                ...
                                <td class="text-right">{{ date('Y/m/d', strtotime($application->birth_date))}} </td>
                                <td class="text-right">{{$application->latin_fullname}} </td>
                                <td class="text-right">@if($application->ar_fullname) {{$application->ar_fullname}} @else -- @endif </td>
                    ...
                    <div class="col-md-8 col-md-offset-4 ">
                      <a href='#' class="btn btn-default btn-primary btn-md col-md-2 col-md-offset-2" onclick="sec_off_printapplication('{{$numbers}}')"> <i class="glyphicon glyphicon-print"></i>  <b>طباعة الكل </b> 
                      </a>  
