                ...
                <div class="panel-body">
                    ...
                    <div id="application">
                        ...
                        <tbody>
                            ...
                            <td><a  onclick="con_get_similarties('{{$application->details->application_no}}')" href="#"><i class="glyphicon glyphicon-user"> </i></a> </td>
                            <td ><a href='#' onclick="con_off_printapplication('{{base64_encode(urlencode($application->details->application_no))}}')"><i class="glyphicon glyphicon-print"></i></a></td>
                    ...
                    <div class="col-md-8 col-md-offset-4 ">
                      <a href='#' class="btn btn-default btn-primary btn-md col-md-2 col-md-offset-2" onclick="con_off_printapplication('{{$numbers}}')"> <i class="glyphicon glyphicon-print"></i>  <b>اعادة الطباعة  </b> 
                      </a>  
